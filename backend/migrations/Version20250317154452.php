 ...
 */
final class Version20250317154452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE status ADD name VARCHAR(255) NOT NULL, ADD description VARCHAR(255) DEFAULT NULL, DROP user_id, DROP status_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE status ADD user_id INT NOT NULL, ADD status_id INT NOT NULL, DROP name, DROP description');
