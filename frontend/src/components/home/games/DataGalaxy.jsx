...
const DataGalaxy = ({ onComplete }) => {
  ...
  const renderIntroScreen = () => (
    ...
    >
      ...
      <h2 className="text-3xl font-bold bg-gradient-to-r from-indigo-400 to-blue-600 bg-clip-text text-transparent mb-4">
        Data Galaxy
      </h2>
      
      <p className="text-lg text-blue-200 mb-8">
        Triez et analysez des données stellaires pour découvrir des patterns cachés dans l'univers!
      </p>
      ...
      <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6 mb-8">
        ...
        <ul className="text-left text-blue-200 space-y-2 mb-4">
          <li className="flex items-start">
            ...
            <span>Triez les astéroïdes par taille, composition et trajectoire</span>
          </li>
          <li className="flex items-start">
            <span className="text-indigo-400 mr-2">✓</span>
            <span>Identifiez les patterns dans les données stellaires</span>
          </li>
          <li className="flex items-start">
            <span className="text-indigo-400 mr-2">✓</span>
            <span>Construisez des modèles prédictifs simples</span>
          </li>
          <li className="flex items-start">
            <span className="text-indigo-400 mr-2">✓</span>
            <span>Visualisez les résultats pour faire des découvertes</span>
          </li>
        </ul>
      </div>
      
      <motion.button
        className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-blue-600 rounded-lg text-white font-bold text-lg shadow-lg"
  ...
  const renderGameScreen = () => (
    <motion.div 
      ...
      exit={{ opacity: 0 }}
    >
      <h2 className="text-2xl font-bold text-white mb-4">Analyse de données en cours...</h2>
  ...
  const renderResultScreen = () => (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-indigo-900 to-blue-900 rounded-xl p-6 shadow-lg mb-8">
        <p className="text-white mb-4">
          Vous avez un talent naturel pour l'analyse de données!
        </p>
