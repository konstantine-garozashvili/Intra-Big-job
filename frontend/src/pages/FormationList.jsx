              ...
              {formations.map((formation) => (
                <React.Fragment key={formation.id}>
                  ...
                  {expandedFormation === formation.id && (
                    <TableRow>
                      <TableCell colSpan={4} className="p-4 bg-gray-50">
                        <div className="space-y-4">
                          {formation.description && (
                            <div className="p-3 bg-white rounded-md shadow-sm">
                              <h4 className="mb-2 text-sm font-medium text-gray-700">Description de la formation :</h4>
                              <p className="text-sm text-gray-600 whitespace-pre-wrap">{formation.description}</p>
                            </div>
                          )}
                          <div>
                            <h4 className="mb-2 text-sm font-medium text-gray-700">Liste des étudiants inscrits :</h4>
                            {formation.students.length > 0 ? (
                              <div className="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3">
                                {formation.students.map(student => (
                                  <div key={student.id} className="flex items-center p-2 space-x-2 bg-white rounded-md shadow-sm">
                              ...
                              <p className="italic text-gray-500">Aucun étudiant inscrit</p>
                            )}
                          </div>
                        </div>
                      </TableCell>
