...
class User implements PasswordAuthenticatedUserInterface, UserInterface
{
    ...
    #[ORM\Column(type: 'boolean', nullable: true)]
    #[Groups(['user:read'])]
    private ?bool $hasChangedInitialPassword = false;
    ...
    public function hasChangedInitialPassword(): ?bool
    {
        return $this->hasChangedInitialPassword;
    }

    public function setHasChangedInitialPassword(?bool $hasChangedInitialPassword): static
    {
